...
const QUALITIES: QualityDef[] = [
  ...
  { tokens: ["m(maj7)", "min(maj7)", "mM7", "mMaj7", "-maj7"], quality: "mM7", label: "Minor Major 7th", intervals: [0, 3, 7, 11] },
  ...
  { tokens: ["7alt", "alt"], quality: "7alt", label: "Altered Dominant", intervals: [0, 4, 8, 10, 13, 15] },
  { tokens: ["maj7#11", "M7#11", "maj7(#11)"], quality: "maj7#11", label: "Major 7th Sharp 11", intervals: [0, 4, 7, 11, 18] },
  { tokens: ["13b9", "13(b9)", "13-9"], quality: "13b9", label: "13th Flat 9", intervals: [0, 4, 7, 10, 13, 21] },
  { tokens: ["7b13", "7(b13)", "7-13"], quality: "7b13", label: "7th Flat 13", intervals: [0, 4, 7, 10, 20] },
  { tokens: ["7#11", "7(#11)"], quality: "7#11", label: "Dominant 7th Sharp 11", intervals: [0, 4, 7, 10, 18] },
  { tokens: ["m(add9)", "madd9", "min(add9)"], quality: "m(add9)", label: "Minor Add 9", intervals: [0, 3, 7, 14] },
  { tokens: ["7#9", "7(#9)", "7aug9"], quality: "7#9", label: "7th Sharp 9 (Hendrix)", intervals: [0, 4, 7, 10, 15] },
  { tokens: ["7b9", "7(b9)", "7-9"], quality: "7b9", label: "7th Flat 9", intervals: [0, 4, 7, 10, 13] },
  { tokens: ["7#5", "7(#5)", "7+5", "aug7", "+7"], quality: "7#5", label: "7th Sharp 5", intervals: [0, 4, 8, 10] },
  { tokens: ["7b5", "7(b5)", "7-5"], quality: "7b5", label: "7th Flat 5", intervals: [0, 4, 6, 10] },
